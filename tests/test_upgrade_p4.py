...
from signal_search import finance as finance_mod
from signal_search import github as github_mod
from signal_search import vault as vault_mod
# ---------- D3 金融源结构化 citation ----------
def test_finance_doc_citation():
    q_data = {"data": {"f58": "测试股", "f43": "10", "f60": "9",
                       "f168": "1", "f170": "20", "f116": "100"}}
    doc = finance_mod._build_doc("600519", "1.600519",
...
def test_github_doc_citation():
    data = {"items": [{"full_name": "owner/repo", "description": "d",
...
def test_bibtex_uses_structured_citation():
    sources = [{
        "url": "https://github.com/owner/repo", "text": "x",
        "citation": {"key": "github-owner-repo", "repo": "owner/repo",
                     "source": "github-api"},
    }]
